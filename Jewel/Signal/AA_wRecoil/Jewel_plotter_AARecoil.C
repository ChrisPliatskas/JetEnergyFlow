...
void Jewel_plotter_AARecoil(int Ptlow, int Pthigh, bool LC, bool embed){

//Open the correct file
TFile* fin;
if(LC)fin=TFile::Open("Summary_jewel_AARecoil_LC.root");
else if(embed)fin=TFile::Open("Summary_jewel_AARecoil_embedded_low.root");
else fin=TFile::Open("Summary_jewel_AARecoil.root");
...
lat.DrawLatex(.38,.82,"JEWEL AA w recoil");
...
pad2->Draw();
pad2->cd();
pad2->DrawFrame(-.6,5e-6,.6,1,";#it{#eta}_{jet};#frac{1}{#it{#sigma}_{jets}} #frac{d#it{#sigma}}{d#it{#eta}}_{jet}");
pad2->SetTicky(1);pad2->SetLogy(1);
...
//lat.DrawLatex(.42,.82,"This thesis");
lat.DrawLatex(.4,.82,"JEWEL AA w recoil");
...
lat1.DrawLatex(.42,.83,"JEWEL AA w recoil");
...
lat1.DrawLatex(.42,.84,"JEWEL AA w recoil");
...
//------------------Saving section-------------------------------------//
TFile*fout; 
if(LC)fout = new TFile(TString::Format("EF_jewel_AARecoil_LC8_pt_%d_%d.root",Ptlow,Pthigh),"RECREATE",TString::Format("EF_jewel_AARecoil_LC8_pt_%d_%d.root",Ptlow,Pthigh));
else if(embed)fout = new TFile(TString::Format("EF_jewel_AARecoil_embed_low_pt_%d_%d.root",Ptlow,Pthigh),"RECREATE",TString::Format("EF_jewel_AARecoil_embed_low_pt_%d_%d.root",Ptlow,Pthigh));
else fout = new TFile(TString::Format("EF_jewel_AARecoil_pt_%d_%d.root",Ptlow,Pthigh),"RECREATE",TString::Format("EF_jewel_AARecoil_pt_%d_%d.root",Ptlow,Pthigh));
fout->cd();
