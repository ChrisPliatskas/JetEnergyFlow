...
//Open input file
TFile*f_in= TFile::Open("UnfoldedResults_ppFinalSolution_wFakes_smallR_Binw3_pt_40_60_ptmin20_Dptmin-1_max28_Iter4.root");
...
double TrackEff[7][6]= {{.02, .02, .03, .03, .04, .04},               //R =0.05
                        {.01, .01, .03, .03, .04, .04},               //R=0.1
                        {.01, .02, .02, .03, .03, .03},               //R=0.15
                        {.01, .03, .02, .02, .02, .02},               //R=0.2
                        {.02, .02, .02, .03, .03, .03},               //R=0.25
                        {.01, .03, .03, .03, .03, .03},               //R=0.3
                        {.01, .03, .02, .02, .02, .02}};              //R=0.35

double Trunc[7][6] =    {{.001, .001, .001, .002, .002, .003},               //R =0.05
                         {.001, .001, .002, .002, .002, .002},               //R=0.1
                         {.001, .001, .004, .004, .004, .004},               //R=0.15
                         {.001, .001, .003, .003, .003, .004},               //R=0.2
                         {.001, .001, .002, .002, .002, .002},               //R=0.25
                         {.001, .001, .002, .002, .005, .005},               //R=0.3
                         {.001, .001, .006, .006, .006, .006}};              //R=0.35


double Niter[7][6]=     {{.005, .005, .005, .01, .01, .01},               //R =0.05
                         {.005, .005, .005, .01, .01, .02},               //R=0.1
                         {.001, .001, .002, .002, .005, .005},               //R=0.15
                         {.001, .001, .002, .002, .003, .003},               //R=0.2
                         {.001, .001, .002, .003, .003, .003},               //R=0.25
                         {.001, .001, .001, .002, .003, .003},               //R=0.3
                         {.001, .001, .001, .003, .003, .003}};              //R=0.35


double Prior[7][6]=     {{.001, .001, .001, .002, .002, .002},               //R =0.05
                         {.001, .001, .001, .001, .007, .007},               //R=0.1
                         {.001, .001, .002, .002, .003, .003},               //R=0.15
                         {.001, .001, .002, .004, .004, .004},               //R=0.2
                         {.003, .003, .003, .02, .02, .02},               //R=0.25
                         {.001, .001, .001, .01, .04, .04},               //R=0.3
                         {.0005, .0015, .005, .02, .02, .03}};              //R=0.35

double Model[7][6]=     {{.01, .01, .01, .03, .03, .03},               //R =0.05
                         {.01, .01, .02, .02, .02, .02},               //R=0.1
                         {.01, .01, .01, .05, .05, .05},               //R=0.15
                         {.01, .03, .03, .03, .04, .04},               //R=0.2
                         {.02, .02, .02, .03, .04, .04},               //R=0.25
                         {.01, .01, .02, .02, .03, .03},               //R=0.3
                         {.03, .03, .03, .04, .04, .04}};              //R=0.35
...
lat1.DrawLatex(.42,.74,"40 < #it{p}_{T,ch jet} < 60 GeV/#it{c}");
...
TFile*Result = TFile::Open("Final_Result_dpt_pp_40_60.root","RECREATE","Final_Result_dpt_pp_40_60.root");
