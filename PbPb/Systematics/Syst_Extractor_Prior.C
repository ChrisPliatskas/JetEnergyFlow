void Syst_Extractor_Prior(TString fname1 = "analysisResults.root",TString fname2 = "analysisResults.root",int ptlow=60, int pthigh=80){
...
ofstream myfile;
myfile.open (Form("Prior_values_PbPb_%d_%d.txt",ptlow,pthigh));
