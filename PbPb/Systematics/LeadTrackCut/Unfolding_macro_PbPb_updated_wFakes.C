...
//Ratios
        ...
        //Saving the output
        TString Outputname = Form("UnfoldedResults_PbPb_ConstSub_wFakes_LC10_smallR_Binw%d_pt_%d_%d_ptmin%d_%d_Dptmin%d_max%d_Iter%d.root",BinWidth,Ptlow,Pthigh,int(ptmin),int(ptmax),int(Dptmin),int(Dptmax),Niter);
