...
void Mod_unfolding_PbPb(TString DatafileName = "AnalysisResults.root",TString ResponsefileName = "Modified_Response_ppMC_pt.root",Double_t Rjet = 0.1, Int_t Ptlow =0 , Int_t Pthigh = 100,Int_t Niter = 1,double perc=0.05){
...
//        pro_data->Scale(1/pro_data->Integral());
        ...
        //Unfolded data
        TH1D*pro_unfolded_data_mod1 = Unfolded_Dpt_data_mod1->ProjectionY(Form("pro_unfolded_data_R%03d_mod1",R),Pro_bin_ptlow_gen, Pro_bin_pthigh_gen);
 ...
 //       pro_unfolded_data_mod1->Scale(1/pro_unfolded_data_mod1->Integral());
        ...
        TH1D*pro_unfolded_data_mod2 = Unfolded_Dpt_data_mod2->ProjectionY(Form("pro_unfolded_data_R%03d_mod2",R),Pro_bin_ptlow_gen, Pro_bin_pthigh_gen);
...
//std::cout<<"CheckPoint H \n";
 TString Outputname = Form("UnfoldedResults_PbPb_FinalSolution_ModResponse_DPt%d_pt_%d_%d_ptmin%d_Dptmin%d_ptmax%d_Dptmax%d_Iter%d.root",int(100*perc),Ptlow,Pthigh,int(ptmin),int(Dptmin),int(ptmax),int(Dptmax),Niter);
