...
void Unfolding_macro_PbPb_TrackEff_updated_wFakes(TString DatafileName = "AnalysisResults.root",TString ResponsefileName = "ResponseMatrix_ppMC_ptmin0.root",Double_t Rjet = 0.1, Int_t Ptlow =0 , Int_t Pthigh = 100, Int_t BinWidth=3, Int_t Niter = 1){
...
//Ratios
        ...
        //Saving the output
        TString Outputname = Form("UnfoldedResults_PbPb_ConstSub_wFakes_LCJC8_TrackEff_smallR_Binw%d_pt_%d_%d_ptmin%d_%d_Dptmin%d_max%d_Iter%d.root",BinWidth,Ptlow,Pthigh,int(ptmin),int(ptmax),int(Dptmin),int(Dptmax),Niter);
