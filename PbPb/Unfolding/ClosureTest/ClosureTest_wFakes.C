...
void ClosureTest_wFakes(TString TestfileName = "AnalysisResults.root", TString ResponsefileName = "ResponseMatrix_ppMC_ptmin0.root", Double_t Rjet = 0.1, Int_t Ptlow =0, Int_t Pthigh = 100, Int_t Niter = 1, Int_t BinWidth=1){
...
Testfile->GetObject("AliAnalysisTaskEmcalJetEnergyFlow_PicoTracks_caloClusters_emcalCells_Embed_ConstSub_SmallR_histos",ali_test);
...
Int_t Pro_bin_pthigh_gen =h2Dpt_Rebined_True->GetXaxis()->FindBin(Pthigh)-1;
        ...
        TString Outputname = Form("ClosureTest_ConstSub_wFakes_LCJC_Binw%d_LC8_pt_%d_%d_ptmin%d_Dptmin%d_max%d_Iter%d.root",BinWidth,Ptlow,Pthigh,int(ptmin),int(Dptmin),int(Dptmax),Niter);
